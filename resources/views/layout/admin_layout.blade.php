...
<body id="app-layout">
    ...
    <script src="/vendor/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js" type="text/javascript"></script>
    ...
    <script src="/vendor/bootstrap-fileinput/js/fileinput_locale_de.js"></script>


    <script src="/vendor/unisharp/laravel-ckeditor/ckeditor.js"></script>
    <script src="/vendor/unisharp/laravel-ckeditor/adapters/jquery.js"></script>
    <script>
        $('.ck-textarea').ckeditor(); // if class is prefered.
